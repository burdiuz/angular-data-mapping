 ...
 */
Entity.prototype.property = function(name, value, readOnly, valueType){
 ...
 */
Entity.prototype.apply = function (data, entityTypeMap) {
  var self = this,
    param;
 ...
 * @param {number} [depth]
 * @param {boolean} [filterEmpty=false]
 * @returns {Object}
 */
Entity.prototype.valueOf = function (depth, filterEmpty) {
  ...
  for (param in this) {
    if (!this.hasOwnProperty(param) || param.charAt() == "$") continue;
    value = this[param];
